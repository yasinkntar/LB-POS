        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_AdditionalInformation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_AdditionalInformationEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_BuildingNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Address_BuildingNumberEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Address_Country = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
                    Address_Floor = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address_FloorEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address_Governate = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Address_GovernateEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Address_Landmark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_LandmarkEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_PostalCode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Address_RegionCity = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Address_RegionCityEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Address_Room = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address_RoomEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address_Street = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Address_StreetEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryZone_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Kitchens_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Section_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerAddresses_DeliveryZone_DeliveryZoneId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Waiters_Section_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Section",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemKitchens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemKitchens_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ItemKitchens_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemKitchens_Kitchens_KitchenId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemModifierGroups_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemModifierOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemModifierOptions_ItemModifierGroups_ModifierGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemKitchens_BranchId",
                table: "ItemKitchens",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemKitchens_ItemId",
                table: "ItemKitchens",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemKitchens_KitchenId",
                table: "ItemKitchens",
                column: "KitchenId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemModifierOptions_ModifierGroupId",
                table: "ItemModifierOptions",
